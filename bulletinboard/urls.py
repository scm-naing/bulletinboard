...
urlpatterns = [
    ...
    path('post/delete/confirm/', views.post_delete_confirm, name='post-delete-confirm'),
    ...
    path('user/delete/confirm/', views.user_delete_confirm, name='user-delete-confirm'),
